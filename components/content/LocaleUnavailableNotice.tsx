...
export default function LocaleUnavailableNotice({
  ...
  return (
    <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 rtl:border-l-0 rtl:border-r-4 border-yellow-400 pl-6 pr-6 rtl:pl-6 rtl:pr-6 py-4 my-8 rounded-r-lg rtl:rounded-l-lg rtl:rounded-r-none">
      <h3 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">
        {t('title')}
      </h3>
      <p className="text-sm text-yellow-700 dark:text-yellow-300 leading-relaxed mb-3">
        {t('message')}
      </p>
      <Link
        href={englishUrl}
